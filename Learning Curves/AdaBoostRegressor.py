...
#Build an AdaBoosted Regressor
abr = AdaBoostRegressor(n_estimators=2)

train_sizes, train_scores, test_scores = learning_curve(abr, X, y, train_sizes=np.arange(1,15000,2000), cv=5)

plt.figure(figsize=(10, 60))
plt.title('AdaBoost Regressor Learning Curve')
